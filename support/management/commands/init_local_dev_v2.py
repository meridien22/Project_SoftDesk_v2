...
class Command(BaseCommand):
    ...
    UserModel.objects.exclude(username="Softdesk").delete()
    Project.objects.all().delete()

    kiyoko_user = UserModel.objects.create_user(
        username="Kiyoko",
        password='pwd_2026',
        date_birth="1980-01-01",
        email="kiyoko@camptocamp.jp",
    )

    takashi_user = UserModel.objects.create_user(
        username="Takashi",
        password='pwd_2026',
        date_birth="1980-02-02",
        email="takashi@camptocamp.jp",
    )

    andre_user = UserModel.objects.create_user(
        username="André",
        password='pwd_2026',
    ...
    valerie_user = UserModel.objects.create_user(
        username="Valérie",
        password='pwd_2026',
        date_birth="1980-04-04",
        email="valerie@esri.fr",
    )

    def get_user(self, name):
        match name:
            case "Kiyoko":
                return self.kiyoko_user
            case "Takashi":
                return self.takashi_user
            case "André":
                return self.andre_user
            case "Valérie":
                return self.valerie_user
            case _:
                return None
